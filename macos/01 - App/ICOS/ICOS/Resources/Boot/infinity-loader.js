// Port of ICOS's src/components/InfinityLoader.js
// (https://github.com/nickvasilescu/ICOS). Three.js import points to the
// vendored bundle; colors + easeInOutQuad are inlined to avoid extra
// fetches. Animation math is native ICOS the native reference except for
...
export class InfinityLoader {
  constructor(canvas, options = {}) {
    ...
    this.wobbleTime = 0;
    // ICOS default: +1 per frame → 720 frames → ~12 s. The boot

// Boot orchestrator — runs the ICOS InfinityLoader (Three.js helix→ring
// morph) inside a WKWebView, plays the ICOS init sound in sync, then
// signals Swift via webkit.messageHandlers.boot when finished.
//
// Timing is a native absorption of the native reference ICOS webapp's
...
const TAGLINE = 'Neuroartan Intelligence Runtime';
...
// Mirrors ICOS's playAudio (src/utils/audioPlayer.js) — fire-and-track
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // ICOS webapp's pacing exactly, which is what the audio file was
  // tuned against.
